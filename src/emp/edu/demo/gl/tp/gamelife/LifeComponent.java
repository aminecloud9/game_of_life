...
//        g2.drawRect(WIDTH, WIDTH, board.getWidth(), board.getHeight());
        ...
        for (int x = 0; x < board.getWidth(); x++) {
            ...
            for (int y = 0; y < board.getHeight(); y++) {
                int ypos = cellDistance(y);
                    if(board.countLivingNeighbors(x, y)==1)g2.setPaint(Color.BLUE);
                    if(board.countLivingNeighbors(x, y)==3)g2.setPaint(Color.YELLOW);
                    if(board.countLivingNeighbors(x, y)==4)g2.setPaint(Color.RED);
                    if(board.countLivingNeighbors(x, y)==5)g2.setPaint(Color.ORANGE);
                    if(board.countLivingNeighbors(x, y)==2)g2.setPaint(Color.GREEN);
                    if(board.countLivingNeighbors(x, y)==7)g2.setPaint(Color.GRAY);
                    if(board.countLivingNeighbors(x, y)==0)g2.setPaint(Color.BLACK);
                    if(board.countLivingNeighbors(x, y)==6)g2.setPaint(Color.PINK);
                    if(board.countLivingNeighbors(x, y)==8)g2.setPaint(Color.magenta);
